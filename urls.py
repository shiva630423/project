"""placement_prediction_type URL Configuration
...
from campus_placements_prediction import settings
...
urlpatterns = [
    ...
    url(r'^View_Placement_Prediction_Type_Ratio/$', serviceprovider.View_Placement_Prediction_Type_Ratio, name="View_Placement_Prediction_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Placement_Type/$', serviceprovider.View_Prediction_Of_Placement_Type, name="View_Prediction_Of_Placement_Type"),
