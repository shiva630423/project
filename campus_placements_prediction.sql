...
--
-- Database: `campus_placements_prediction`
--
CREATE DATABASE IF NOT EXISTS `campus_placements_prediction` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `campus_placements_prediction`;
...
('cuqdjlb04o7ksvymzlqoaxvjixtlivcg', 'eyJ1c2VyaWQiOjF9:1oKzo2:VFHfeg_6UKXetd3MkgOyZBLl2tlgGR9BEwuWqVwliAQ', '2022-08-22 10:16:18.801370'),
...
('wk8ftbgexrjlak0gdlkyhxbt6hj7jkea', 'eyJ1c2VyaWQiOjJ9:1oL2GD:JcILuoEkhNvCKEMpPTzQbia-_8r0p66CLLfMxLq81dE', '2022-08-22 12:53:33.141539'),
...
(1, 'Rajesh', 'Rajesh123@gmail.com', 'Rajesh', '9535866270', 'India', 'Karntaka', 'Bangalore', '#892,4th Cross,Rajajinagar', 'Male'),
(2, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,8th Cross,Vijayanagar', 'Male');
...
(68, 'SVM', '52.69360269360269'),
(69, 'Logistic Regression', '52.69360269360269'),
(70, 'Decision Tree Classifier', '52.69360269360269'),
(71, 'KNeighborsClassifier', '48.31649831649832'),
(72, 'Random Forest Classifier', '52.69360269360269');
...
(14, 'Placed', '66.66666666666666'),
(15, 'Not Placed', '33.33333333333333');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_placement_prediction_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_placement_prediction_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `RID` varchar(300) NOT NULL,
  `Age` varchar(300) NOT NULL,
  `Gender` varchar(300) NOT NULL,
  `Stream` varchar(300) NOT NULL,
  `Internships` varchar(300) NOT NULL,
  `Btech_CGPA` varchar(300) NOT NULL,
  `SSLC_Percentage` varchar(300) NOT NULL,
  `PUC_Percentage` varchar(300) NOT NULL,
  `Hostel` varchar(300) NOT NULL,
  `HistoryOfBacklogs` varchar(300) NOT NULL,
...
--
-- Dumping data for table `remote_user_placement_prediction_type`
--

INSERT INTO `remote_user_placement_prediction_type` (`id`, `RID`, `Age`, `Gender`, `Stream`, `Internships`, `Btech_CGPA`, `SSLC_Percentage`, `PUC_Percentage`, `Hostel`, `HistoryOfBacklogs`, `Salary`, `Prediction`) VALUES
(1, 'A2R60LKYYCDYBM', '22', 'Male', 'Mechanical', '0', '8', '76', '73', '1', '0', '425000', 'Placed'),
(2, 'A3R4VJELGQJYFS', '22', 'Male', 'Electronics And Communication', '0', '6', '71', '76', '0', '0', '0', 'Not Placed'),
(3, 'A29LGZHPTDW8B7', '21', 'Male', 'Civil', '0', '6', '88', '68', '0', '0', '0', 'Not Placed'),
(4, 'A32PUB76V2BNII', '21', 'Male', 'Electrical', '0', '8', '71', '79', '1', '0', '31000', 'Placed'),
(5, 'A1RRMZKOMZ2M7J', '22', 'Male', 'Electrical', '1', '8', '78', '76', '0', '0', '24000', 'Placed'),
(7, 'AY54QSGO3KWEM', '22', 'Male', 'Mechanical', '0', '8', '90', '76', '1', '0', '200000', 'Placed');
